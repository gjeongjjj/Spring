...
<script>
	...
	function inCheck() {
	   ...
	   if (pCheck && p2Check ) {
	      //=> submit 확인
	      if ( confirm("정말 Password수정하십니까? (Yes:확인/No:취소)") ) {
	         //=> submit 진행
	         return true;
	      }else {
	         alert("~~ 가입이 취소 되었습니다. ~~");
...
<body>
	...
	<div align="center">
		<br> <b> => 새로운 Password 입력하세요(⌐■_■) </b>
		<form action="pwUpdate" method="post">
			<table>
				<tr height="40">
					<td bgcolor="#c63939"><label>NEW Password </label></td>
					<td><input type="password" id="password" name="password">
						<br> <span id="pMessage" class="eMessage"></span></td>
				</tr>

				<tr height="40">
					<td bgcolor="#c63939"><label>NEW Password 재확인 </label></td>
					<td><input type="password" id="password2"
						placeholder="반드시 입력하세요.*** "> <br> <span
