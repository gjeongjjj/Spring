...
function idDupCheck() {
	...
	// 2) 서버로 id 확인 요청 -> 결과는 view_Page팝업창 으로. 
		...
		window.open(url, '_blank', 'width=400,height=500,resizable=yes,scrollbars=yes,toolbar=no,menubar=yes');
	}
		...
		<table>
			...
			<tr height="40">
				...
				<td><input type="text" name="info" id="info"
					placeholder="자기소래 & 희망사항" size="20"></td>
			</tr>
			<tr height="40">
				...
				<td><input type="text" name="point" id="point"
					...
					id="oMessage" class="eMessage"> </span></td>
			</tr>
			<tr height="40">
				<td bgcolor="RosyBrown"><label for="birthday">BIRTHDAY
				</label></td>
				<td><input type="date" name="birthday" id="birthday" size="20">
			...
			<tr height="40">
				...
				<td>
					<img alt="MyImage" src="/resources/images/basicman4.png"
