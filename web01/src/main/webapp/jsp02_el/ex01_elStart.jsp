...
1. 값(변수의 값) 의 출력 비교
=> Java 표현식: <%=name %>
=> Java out객체: <%out.print("Java out 객체 => " + name); %>
=> EL 출력: ${"~~ Hello EL, 표현언어 ~~"}
	-> Java변수 출력: \${"EL로 Java변수 출력 => " + name} : 500 발생
...
\${5-2} => ${5-2}
\${5*2} => ${5*2}
\${5/2} => ${5/2} -> 나누기 실수형으로 처리
\${5%2} => ${5%2}

=> 관계(비교) 연산 : (결과가 ture 아니면 false)
<!-- >, <, >=, <=, ==,!= -->
...
=> request 객체의 Parameter(request.getParameter)를 전달하는 el의 내부객체 제공 : param
